...
public class CustomizeGirlSpecial2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        hair_styles[0] = Resources.Load<Sprite>("Girl/Special2/Hair/hair-1");
        hair_styles[1] = Resources.Load<Sprite>("Girl/Special2/Hair/hair-2");
        hair_styles[2] = Resources.Load<Sprite>("Girl/Special2/Hair/hair-3");
        hair_styles[3] = Resources.Load<Sprite>("Girl/Special2/Hair/hair-4");


        hair_styles_vector = new Vector2[4];
        hair_styles_vector[0] = new Vector2(0.21f, 10.96f);
        hair_styles_vector[1] = new Vector2(0.32f, 9.23f);
        hair_styles_vector[2] = new Vector2(0.36f, 8.83f);
        hair_styles_vector[3] = new Vector2(0.14f, 10.25f);
        ...
        shirt_styles[0] = Resources.Load<Sprite>("Girl/Special2/Shirt/shirt-1");
        shirt_styles[1] = Resources.Load<Sprite>("Girl/Special2/Shirt/shirt-2");
        shirt_styles[2] = Resources.Load<Sprite>("Girl/Special2/Shirt/shirt-3");


        shirt_styles_vector = new Vector2[3];
        shirt_styles_vector[0] = new Vector2(-0.2f, -2.48f);
        shirt_styles_vector[1] = new Vector2(1.99f, -2.4f);
        shirt_styles_vector[2] = new Vector2(20.37f, 3.33f);
